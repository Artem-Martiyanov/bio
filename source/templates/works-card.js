        ...
        <div class="works__content">
          ...
          <div class="works__inner">
            ...
            <footer class="works__links">
              <a class="works__link" href="${params?.deployLink}" target="_blank" title="Опубликованная версия.">
                <span class="visually-hidden">Опубликованная версия.</span>
                <svg width="40" height="40">
                  <use href="./images/stack.svg#out-link"></use>
                </svg>
              </a>
              <a class="works__link" href="${params?.ghLink}" target="_blank" title="Проект на Гитхаб.">
